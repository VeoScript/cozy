  ...
  return (
    <>
      ...
      <div className="fixed md:hidden bottom-0 z-50 flex flex-row items-center justify-between w-full px-5 bg-honey">
        ...
        <Link href="/contacts">
          <a className={`${router.pathname === '/contacts' ? 'bg-modern-dim text-honey border-4 border-honey -translate-y-3' : 'bg-none text-[#333]'} px-3 py-3 rounded-full transition ease-in-out duration-300 hover:bg-modern-black hover:text-honey`}>
            <ContactsIcon />
          </a>
        </Link>
        <Link href="/diary">
