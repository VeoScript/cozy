                ...
                <div className="mt-5">
                  <form onSubmit={handleSubmit(onEditProfile)} className="flex flex-col w-full space-y-3">
                    ...
                    <div className="flex items-center w-full px-3 rounded-lg bg-[#1F1F1F]">
                      ...
                      <input type="text" name="name" placeholder="Name" className="w-full h-full px-3 py-5 bg-[#1F1F1F] text-modern-white focus:outline-none disabled:cursor-not-allowed disabled:opacity-50" {...register("name", { required: true })} disabled={isSubmitting} />
