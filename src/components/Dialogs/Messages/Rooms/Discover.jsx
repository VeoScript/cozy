            ...
            >
              <div className="inline-block w-full max-w-3xl my-8 overflow-hidden text-left align-middle transition-all transform border-2 border-honey bg-modern-black text-modern-white shadow-xl rounded-2xl">
                ...
                >
                  ...
                  <button
                    className="fixed top-2 right-2 transition ease-in-out duration-200 hover:scale-90 focus:outline-none"
                    type="button"
                    onClick={closeModal}
                  >
                ...
                <Scrollbar className="flex flex-row w-full h-full max-h-[28rem] overflow-y-auto px-3 py-5">
                  <div className="flex flex-col md:flex-row items-center justify-start md:justify-between w-full px-3 py-2 rounded-xl transition-all duration-300 hover:bg-modern-dim">
                    <div className="flex flex-row items-center w-full space-x-3">
                      ...
                      <div className="flex flex-col items-start">
                        <div className="flex flex-row items-center space-x-1">
                          <span className="font-normal text-base">Room Name</span>
