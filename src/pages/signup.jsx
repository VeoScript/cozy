            ...
            <div className="flex flex-col w-full max-w-md">
              <form onSubmit={handleSubmit(handleSignUp)} className="flex flex-col w-full space-y-3">
                <div className="flex items-center w-full px-3 rounded-lg bg-[#1F1F1F]">
                  ...
                  <input type="text" name="avatar" placeholder="Profile URL" className="w-full h-full px-3 py-5 bg-[#1F1F1F] text-honey focus:outline-none disabled:cursor-not-allowed disabled:opacity-50" {...register("avatar", { required: true, pattern: { value: /(http(s)?:\/\/.)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/g, message: "Invalid URL" } })} disabled={isSubmitting} />
                ...
                <div className="flex items-center w-full px-3 rounded-lg bg-[#1F1F1F]">
                  ...
                  <input type="text" name="email" placeholder="Email" className="w-full h-full px-3 py-5 bg-[#1F1F1F] text-honey focus:outline-none disabled:cursor-not-allowed disabled:opacity-50" {...register("email", { required: true, pattern: { value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i, message: "Invalid Email" } })} disabled={isSubmitting} />
